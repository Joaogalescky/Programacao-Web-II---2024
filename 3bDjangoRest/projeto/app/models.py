...
class Usuario(models.Model):
    ...
    # retornar uma representação de string de um objeto.
    def __str__(self):
        return self.nome
...
class Registro(models.Model):
    ...
    def __str__(self):
        return f"{self.prescricao.paciente.nome} - {self.prescricao.medicamento.nome} - {self.horarioPrescrito.strftime('%Y-%m-%d %H:%M')}"